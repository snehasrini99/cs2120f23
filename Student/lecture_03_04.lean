...
def id_poly' (α : Type) : α → α
| v => v
/-first argument is a type and then 2nd argument is the value of the type-/
/-!
...
/-here is partial evaluation, only one argument is given-/
...
| _, v => v
/-2 tic marks implicity infers the type-/
/-!
...
/-!
comp
let alpha, beta, gama: Type
takea a function from α to β
takes a function from β to γ
return a function from α to γ
-/
...
-- This apply2 version is specialized for "Natty" values
